...
export const metadata = {
    ...
    description: 'Портфолио озорного стендап-комика',
};
    ...
    return (
        <html lang="ru">
            <body className="bg-neutral-950 text-neutral-100 antialiased">
                ...
                <section className="w-full px-6 flex justify-center items-center mt-20 mb-32">
                    <h2 className="max-w-5xl text-center font-black tracking-wide leading-tight text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
